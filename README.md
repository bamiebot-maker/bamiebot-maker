...
## Tech Stack
![Skills](https://skillicons.dev/icons?i=html,css,js,ts,react,nodejs,php,solidity,rust,go,java,postgres,mongodb,aws,saas,github,chatgpt,docker,linux,git,ai)
